...
var Container = (function (_super) {
    ...
    Container.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", null, React.createElement("div", null, React.createElement("h1", null, " First Example"), React.createElement(EditableField_1.EditableField, {initialValue: false}), React.createElement(DebugComponent, {editableFieldInput: this.state.testGlobalReference}), React.createElement("h4", {onClick: function (event) {
            console.log("Clicked h4", { "this.testGlobalReference": _this.testGlobalReference });
        }}, " Click test")), React.createElement("div", null, React.createElement("h1", null, " Second Example"), React.createElement(EditableField_1.EditableField, {initialValue: "this is the preliminary variable"}), React.createElement(DebugComponent, {editableFieldInput: this.state.testGlobalReference}), React.createElement("h4", {onClick: function (event) {
            console.log("Clicked h4", { "this.testGlobalReference": _this.testGlobalReference });
        }}, " Click test")), React.createElement("div", null, React.createElement("h1", null, " Third Example"), React.createElement(EditableField_1.EditableField, {initialValue: new Date()}), React.createElement(DebugComponent, {editableFieldInput: this.state.testGlobalReference}), React.createElement("h4", {onClick: function (event) {
            console.log("Clicked h4", { "this.testGlobalReference": _this.testGlobalReference });
        }}, " Click test")), React.createElement("div", null, React.createElement("h1", null, " Fifth Example -- Has to be another date "), React.createElement(EditableField_1.EditableField, {initialValue: new Date(), requireSameTypeOnSave: true}), React.createElement(DebugComponent, {editableFieldInput: this.state.testGlobalReference}), React.createElement("h4", {onClick: function (event) {
            console.log("Clicked h4", { "this.testGlobalReference": _this.testGlobalReference });
        }}, " Click test"))));
    };
    return Container;
